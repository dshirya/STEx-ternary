...
def plot_elements_from_plsda_loadings(pls_loadings, element_properties_file="data/elemental-property-list.xlsx"):
    """
    ...
    In addition, elements are colored according to their group using the given group dictionaries.
